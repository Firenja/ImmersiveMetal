...
/*
                            //Ingots
                            ItemList.copperIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("copperIngot")),
                            ItemList.tinIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("tinIngot")),
                            ItemList.bronzeIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("bronzeIngot")),
                            ItemList.zincIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("zincIngot")),
                            ItemList.brassIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("brassIngot")),
                            ItemList.silverIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("silverIngot")),
                            ItemList.platinumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("platinumIngot")),
                            ItemList.promethiumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("promethiumIngot")),
                            ItemList.hard_ironIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("hard_ironIngot")),
                            ItemList.mithrilIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("mithrilIngot")),
                            ItemList.orichalcumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("orichalcumIngot")),
                            ItemList.adamantIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("adamantIngot")),
                            ItemList.glowing_ironIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("glowing_ironIngot")),
                            ItemList.uridiumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("uridiumIngot")),
                            ItemList.tritaniumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("tritaniumIngot")),
                            ItemList.quadiumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("quadiumIngot")),
                            ItemList.etheriumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("etheriumIngot")),
                            ItemList.byzaniumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("byzaniumIngot")),
                            ItemList.bologniumIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("bologniumIngot")),
                            ItemList.duratineIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("duratineIngot")),
                            ItemList.dark_ironIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("dark_ironIngot")),
                            ItemList.arenakIngot = new Item(new Item.Properties().group(immersive_metal)).setRegistryName(getResourceLocation("arenakIngot")),
