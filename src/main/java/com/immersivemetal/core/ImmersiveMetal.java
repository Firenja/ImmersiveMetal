            ...
            event.getRegistry().registerAll
                    (
                       ...
                       //Ingots
                            ...
                            //axe
                            ItemList.copperAxe = new AxeItem(ToolMaterialList.Copper, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("copper_axe"),
                            ItemList.bronzeAxe = new AxeItem(ToolMaterialList.Bronze, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("bronze_axe"),
                            ItemList.brassAxe = new AxeItem(ToolMaterialList.Brass, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("brass_axe"),
                            ItemList.silverAxe = new AxeItem(ToolMaterialList.Silver, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("silver_axe"),
                            ItemList.platinumAxe = new AxeItem(ToolMaterialList.Platinum, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("platinum_axe"),
                            ItemList.promethiumAxe = new AxeItem(ToolMaterialList.Promethium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("promethium_axe"),
                            ItemList.hard_ironAxe = new AxeItem(ToolMaterialList.Hard_iron, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("hard_iron_axe"),
                            ItemList.mithrilAxe = new AxeItem(ToolMaterialList.Mithril, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("mithril_axe"),
                            ItemList.orichalcumAxe = new AxeItem(ToolMaterialList.Orichalcum, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("orichalcum_axe"),
                            ItemList.adamantAxe = new AxeItem(ToolMaterialList.Adamant, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("adamant_axe"),
                            ...
                            ItemList.uridiumAxe = new AxeItem(ToolMaterialList.Uridium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("uridium_axe"),
                            ItemList.tritaniumAxe = new AxeItem(ToolMaterialList.Tritanium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("tritanium_axe"),
                            ItemList.quadiumAxe = new AxeItem(ToolMaterialList.Quadium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("quadium_axe"),
                            ItemList.etheriumAxe = new AxeItem(ToolMaterialList.Etherium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("etherium_axe"),
                            ItemList.byzaniumAxe = new AxeItem(ToolMaterialList.Byzanium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("byzanium_axe"),
                            ItemList.bologniumAxe = new AxeItem(ToolMaterialList.Bolognium, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("bolognium_axe"),
                            ItemList.duratineAxe = new AxeItem(ToolMaterialList.Duratine, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("duratine_axe"),
                            ItemList.dark_ironAxe = new AxeItem(ToolMaterialList.Dark_iron, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("dark_iron_axe"),
                            ItemList.arenakAxe = new AxeItem(ToolMaterialList.Arenak, 9, 1, new Item.Properties().group(immersive_metal)).setRegistryName("arenak_axe"),
